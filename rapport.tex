...
\begin{document}
    ...
    \begin{description}[style=nextline]
        \item[Pas de réponse donnée]Le toast invite l'utilisateur à répondre à la question.
    ...
    Le code de \textsc{History Pub} reprends, à certains endroits précis, du code open-source. Ces parties de code open-source se retrouvent ci-dessous :
