...
\begin{document}
    ...
    \begin{boutons}[style=nextline]
        \item[Bouton de triche]Il retire toutes les réponses incorrectes et coche automatiquement la bonne réponse. Il faut ensuite appuier sur le bouton OK.
    ...
    Pour ce type d'épreuve:
    \begin{boutons}[style=nextline]
        \item[Bouton de triche]Il remplit automatiquement l'EditText avec la ou les bonne(s) réponse(s). Aucune modification ne sera alors possible dans cet EditText. Il faut ensuite appuier sur le bouton OK.
        \item[Bouton d'aide]Il remplit automatiquement l'EditText avec la première lettre de chaque mot, et une virgule entre les différentes lettres ainsi révélées. Il faudra cependant compléter la réponse.
    \end{boutons}
    ...
    Pour ce type d'épreuve:
        \begin{boutons}[style=nextline]
            \item[Bouton de triche]Il remplit automatiquement l'EditText avec la bonne réponse. Aucune modification ne sera alors possible dans cet EditText. Il faut ensuite appuier sur le bouton OK.
            \item[Bouton d'aide]Il remplit automatiquement l'EditText avec la première lettre de la réponse. Il faudra cependant compléter la réponse.
        \end{boutons}
    ...
    Pour ce type d'épreuve:
    \begin{boutons}[style=nextline]
        \item[Bouton de triche]Il affiche automatiquement la bonne image dans la zone de prévisualisation. Il faut ensuite appuier sur le bouton OK.
